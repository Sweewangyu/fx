...
class PromptTemplateBank:
    ...
    TEMPLATES: Dict[str, List[TemplateVariant]] = {
        ...
        # =====================================================================
        # ---------------------------------------------------------------
        # Task 4a: Ordering (Boolean) - "Did {activity_a} occur before {activity_b}?"
        # Answer: yes/no
        # ---------------------------------------------------------------
        "ordering_boolean": [
            TemplateVariant(
        ...
        # ---------------------------------------------------------------
        # Task 4b: Ordering (Category) - "Which occurred first?"
        ...
        "ordering_category": [
            ...
            TemplateVariant(
                question="Which of these two activities was earlier: {activity_a} or {activity_b}?",
                answer="{first_activity}.",
            ),
            TemplateVariant(
            ...
            TemplateVariant(
                question="Looking at the data, which happened first: {activity_a} or {activity_b}?",
                answer="{first_activity}.",
            ),
        ],
        # =====================================================================
