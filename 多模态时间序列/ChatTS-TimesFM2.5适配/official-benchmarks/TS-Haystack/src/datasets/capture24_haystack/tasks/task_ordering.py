...
from src.datasets.capture24_haystack.tasks.base_task import BaseTaskGenerator
from src.datasets.capture24_haystack.utils import find_sequential_positions
...
class OrderingTaskGenerator(BaseTaskGenerator):
    ...
    def generate_sample(
        ...
        template_task = f"ordering_{question_format}"

        # Generate question and answer using the format-specific template bank
        ...
        final_answer_type = question_format
