...
from src.datasets.capture24_haystack.tasks.base_task import (
    BaseTaskGenerator,
)
from src.datasets.capture24_haystack.tasks.task_existence import (
    ExistenceTaskGenerator,
)
from src.datasets.capture24_haystack.tasks.task_localization import (
    LocalizationTaskGenerator,
)
from src.datasets.capture24_haystack.tasks.task_counting import (
    CountingTaskGenerator,
)
from src.datasets.capture24_haystack.tasks.task_ordering import (
    OrderingTaskGenerator,
)
from src.datasets.capture24_haystack.tasks.task_state_query import (
    StateQueryTaskGenerator,
)
from src.datasets.capture24_haystack.tasks.task_antecedent import (
    AntecedentTaskGenerator,
)
from src.datasets.capture24_haystack.tasks.task_comparison import (
    ComparisonTaskGenerator,
)
from src.datasets.capture24_haystack.tasks.task_multi_hop import (
    MultiHopTaskGenerator,
)
from src.datasets.capture24_haystack.tasks.task_anomaly_detection import (
    AnomalyDetectionTaskGenerator,
)
from src.datasets.capture24_haystack.tasks.task_anomaly_localization import (
